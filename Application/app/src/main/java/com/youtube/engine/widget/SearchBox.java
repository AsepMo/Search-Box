...
import com.youtube.engine.view.MaterialMenuDrawable.IconState;
import com.youtube.engine.view.MaterialMenuView;

import java.util.ArrayList;
import java.util.List;

import com.youtube.engine.animation.ReverseInterpolator;
import com.youtube.engine.animation.SupportAnimator;
import com.youtube.engine.animation.ViewAnimationUtils;
...
public class SearchBox extends RelativeLayout {
	...
	public SearchBox(final Context context, AttributeSet attrs, int defStyle) {
        ...
        this.thumbnails = (ImageView) findViewById(R.id.ic_thumbnails);
        this.thumbnails.setVisibility(View.GONE);
        this.thumbnails.setOnClickListener(new OnClickListener() {

                @Override
                public void onClick(View v) {
                    if (thumbnailListener != null)
						thumbnailListener.onThumbnailClick();
                }
        });
	...
	public void setThumbnails(Drawable icon) {
        thumbnails.setVisibility(View.VISIBLE);
        thumbnails.setImageDrawable(icon);
    }

    public void setThumbnails(Integer icon) {
        setThumbnails(getResources().getDrawable(icon));
    }

    public void setThumbnails(String icon) {
        thumbnails.setVisibility(View.VISIBLE);
        Glide.with(context)
            .load(icon)
            .apply(new RequestOptions().circleCrop().placeholder(R.drawable.ic_history).error(R.drawable.ic_history))
            .into(thumbnails);
    }
    ...
    public interface ThumbnailListener {
        /**
         * Called when the thumbnails button is pressed
         */
